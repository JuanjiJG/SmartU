...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <p class="lead">{{ __("SmartU is born of the multidisciplinary project made in the") }} <strong><a target="_blank" href="http://www.ugr.es/">{{ __("University of Granada") }}</a></strong>, {{ __("as part of the") }} <strong><a target="_blank" href="https://ec.europa.eu/programmes/horizon2020/">H2020</a></strong> {{ __("program to connect the universities to the smart cities") }}.</p>
            <p class="lead">{{ __("This web application was developed by") }} <strong><a target="_blank" href="https://github.com/xXJuAnJi05Xx">Juanjo Jiménez</a></strong>, {{ __("and the source code has been released under the") }} <strong><a target="_blank" href="https://opensource.org/licenses/MIT">MIT</a></strong>{{ __(" license.") }}</p>
