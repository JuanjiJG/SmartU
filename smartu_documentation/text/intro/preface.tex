...
Como resultado de este trabajo, se obtienen una serie de \textbf{resultados y conclusiones} sobre cómo ha sido este primer proyecto de equipo multidisciplinar, que servirá de ayuda para mejorar en el futuro los problemas encontrados.
...
As a result from this project, we got a bunch of \textbf{results and conclusions} about how well this first multidisciplinary project was, which will be used to improve in the future the found problems.
